...
// Handle è la funzione che instrada le richieste alle rispettive funzioni
...
func helloWorldHandler(w http.ResponseWriter, r *http.Request) {
	// Chiamata al handler specifico della funzione hello-world
	helloWorld.Handle(w, r)
}

func apiHandler(w http.ResponseWriter, r *http.Request) {
	// Chiamata al handler specifico della funzione api
	api.Handle(w, r)
}

func speechToTextHandler(w http.ResponseWriter, r *http.Request) {
	// Chiamata al handler specifico della funzione speech-to-text
	speechToText.Handle(w, r)
}
